...
from fraud_detection.data_access.sensor_data import SensorData
from fraud_detection.utils.main_utils import read_yaml_file
...
class DataIngestion:
    ...
    def export_data_into_feature_store(self) -> DataFrame:
        ...
        try:
            ...
            dataframe = transaction_data.export_collection_as_dataframe(collection_name=self.data_ingestion_config.collection_name)
